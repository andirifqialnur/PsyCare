        ...
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <a class="text text-decoration-none"><h5 class="fw-bolder">Aoran Galeal</h5></a><br>
                            <!-- Product price-->
                            $80.00
                        </div>
                    </div>
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><a class="btn mt-auto" href="#" data-bs-toggle="modal" data-bs-target="#chatmodal" style="color: #ffff;">Chat</a></div>
                    </div>
                </div>
            </div>
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <!-- Product image-->
                    <img class="card-img-top" src="<?= base_url('assets/img/chat2.jpg')?>" />
                    <!-- Product details-->
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <a class="text text-decoration-none"><h5 class="fw-bolder">Christina Rust</h5></a><br>
                            <!-- Product reviews-->
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="badge text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Discount</div>
                    <!-- Product image-->
                    <img class="card-img-top" src="<?= base_url('assets/img/chat3.jpg')?>" />
                    <!-- Product details-->
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <a class="text text-decoration-none"><h5 class="fw-bolder">Sabrina Velocia</h5></a><br>
                            <!-- Product price-->
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <a class="text text-decoration-none"><h5 class="fw-bolder">Fransisca Octaviona</h5></a><br>
                            <!-- Product reviews-->
                            <div class="d-flex justify-content-center small text-warning mb-2">
                                <div class="bi-star-fill"></div>
                                <div class="bi-star-fill"></div>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="badge text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Discount</div>
                    <!-- Product image-->
                    <img class="card-img-top" src="<?= base_url('assets/img/chat5.jpg')?>" />
                    <!-- Product details-->
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <a class="text text-decoration-none"><h5 class="fw-bolder">Jason Dee</h5></a><br>
                            <!-- Product price-->
                            <span class="text-muted text-decoration-line-through">$50.00</span>
                            $25.00
                        </div>
                    ...
                    <!-- Product actions-->
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><a class="btn mt-auto" href="#" style="color: #ffff";>Chat</a></div>
                    </div>
                </div>
            </div>
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <a class="text text-decoration-none"><h5 class="fw-bolder">Kamal Ibrahim</h5></a><br>
                            <!-- Product price-->
                            $120.00
                        </div>
                    </div>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="badge text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Discount</div>
                    <!-- Product image-->
                    <img class="card-img-top" src="<?= base_url('assets/img/chat7.jpg')?>" />
                    <!-- Product details-->
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <a class="text text-decoration-none"><h5 class="fw-bolder">Thomas Fred</h5></a><br>
                            <!-- Product reviews-->
                            <div class="d-flex justify-content-center small text-warning mb-2">
                                <div class="bi-star-fill"></div>
                                <div class="bi-star-fill"></div>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <a class="text text-decoration-none"><h5 class="fw-bolder">Diana Olivia</h5></a><br>
                            <!-- Product reviews-->
                            <div class="d-flex justify-content-center small text-warning mb-2">
                                <div class="bi-star-fill"></div>
                                <div class="bi-star-fill"></div>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <h5 class="fw-bolder">Mark Khandwald</h5>
                            <!-- Product reviews-->
                            <div class="d-flex justify-content-center small text-warning mb-2">
                                <div class="bi-star-fill"></div>
                                <div class="bi-star-fill"></div>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <h5 class="fw-bolder">Daniel Octaf</h5>
                            <!-- Product reviews-->
                            <div class="d-flex justify-content-center small text-warning mb-2">
                                <div class="bi-star-fill"></div>
                                <div class="bi-star-fill"></div>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <h5 class="fw-bolder">Leonita Victoria</h5>
                            <!-- Product reviews-->
                            <div class="d-flex justify-content-center small text-warning mb-2">
                                <div class="bi-star-fill"></div>
                                <div class="bi-star-fill"></div>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <h5 class="fw-bolder">Zaid Hasbullah</h5>
                            <!-- Product reviews-->
                            <div class="d-flex justify-content-center small text-warning mb-2">
                                <div class="bi-star-fill"></div>
                                <div class="bi-star-fill"></div>
