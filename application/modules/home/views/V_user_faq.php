            ...
            <div class="row gx-5 align-items-center justify-content-center">
                <div class="col-lg-8 col-xl-7 col-xxl-6">
                    <div class="px-5 my-5 text-center text-xl-start">
                        <h1 class="display-5 fw-bolder text-black mb-2">Frequently Asked Questions</h1>
                        <p class="lead fw-normal text-black-50 mb-4">How can we help you?</p>
                    </div>
                </div>
                <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center">
                    <img src="<?= base_url('assets/svg/undraw_Questions_re_1fy7.svg')?>" class="d-block w-100">
                </div>
