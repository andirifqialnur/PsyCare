        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Discuss Form</h1>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="news-img-box">
              <img src="<?= base_url ('assets/img/slide-3.jpg');?>" alt="" class="img-fluid">
            </div>
          </div>
              ...
              <ul class="list-comments">
                <li>
                  <div class="comment-avatar">
                    <img src="<?= base_url ('assets/img/author-2.jpg');?>" alt="">
                  </div>
                ...
                <li class="comment-children">
                  <div class="comment-avatar">
                    <img src="<?= base_url ('assets/img/author-1.jpg');?>" alt="">
                  </div>
                  <div class="comment-details">
